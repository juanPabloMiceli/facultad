...
set iskeyword+=?,=,&,#,<,>
syn keyword tadADT ArregloDimensionable Bool Cola ColaDePrioridad Conjunto Diccionario Famoso Multiconjunto Nat Palindromo Pila Secuencia String ÁrbolBinario
hi tadADT cterm=bold,underline ctermfg=2
syn keyword tadSort ab ad bool cola colaPrior conj dicc multiconj nat palindromo pila secu string α κ σ
...
syn keyword tadConstructor  •  Ag agregar apilar bin crearArreglo definir encolar false medio medioDoble nil suc true vacía vacío zero ∅ ⟨ ⟨⟩ ⟩
hi tadConstructor ctermfg=4
syn keyword tadEliminator =0? def? der desapilar desencolar está? fin izq nil? obtener pred prim próximo raíz tam tope vacía? ver π₁ π₂ π₃ π₄ ∊
