...
set iskeyword+=?,=,&,#,<,>
syn keyword tadADT ArregloDimensionable Bool Cola ColaDePrioridad Conjunto Diccionario Famoso Grupo Multiconjunto Nat Persona Pila Regalo Secuencia String ÁrbolBinario
hi tadADT cterm=bold,underline ctermfg=2
syn keyword tadSort ab ad bool cola colaPrior conj dicc grupo multiconj nat persona pila regalo secu string α κ σ
...
syn keyword tadOtherOperations  ◦  # & altura borrar claves colaAConjunto com dameUno esConjuntoValido esHoja? está inorder long máx mín pertenece postorder preorder sinGruposVacios sinUno tamaño unionDeConjuntos últ ∅? ⊆
