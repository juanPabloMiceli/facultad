...
set iskeyword+=?,=,&,#,<,>
syn keyword tadADT ArregloDimensionable Bool Cola ColaDePrioridad Conjunto Diccionario Famoso Multiconjunto Nat Pila Polinomio Secuencia String ÁrbolBinario
hi tadADT cterm=bold,underline ctermfg=2
syn keyword tadSort ab ad bool cola colaPrior conj dicc multiconj nat pila polinomio secu string α κ σ
...
syn keyword tadConstructor  •  Ag Cte X apilar bin crearArreglo definir encolar false nil suc true vacía vacío zero ∅ ⟨ ⟨⟩ ⟩
hi tadConstructor ctermfg=4
syn keyword tadEliminator =0? Evaluar def? der desapilar desencolar fin izq nil? obtener pred prim próximo raíz tam tope vacía? π₁ π₂ π₃ π₄ ∊
