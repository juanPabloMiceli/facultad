...
set iskeyword+=?,=,&,#,<,>
syn keyword tadADT ArregloDimensionable Bool Cola ColaDePrioridad Conjunto Diccionario Famoso Multiconjunto Nat Palabra Pila Rosetree Secuencia String ÁrbolBinario
hi tadADT cterm=bold,underline ctermfg=2
syn keyword tadSort ab ad bool cola colaPrior conj dicc multiconj nat palabra pila rosetree secu string α κ σ
...
syn keyword tadOtherOperations  ◦  # & altura borrar claves com dameUno esHoja? está filtrarPalabras inorder long máx mín palabrasPosibles palabrasPresentes postorder prefijarEnTodos preorder ramasHijos sinUno tamaño últ ∅? ⊆
