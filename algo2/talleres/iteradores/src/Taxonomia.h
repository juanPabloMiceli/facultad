...
public:
    ...
    explicit Taxonomia(const string&);
    ~Taxonomia();
...
private:
        ...
        Nodo() : valor(), hijos() {}
        explicit Nodo(T _valor) : valor(_valor), hijos() {}
        };
...
public:
    ...
    private:
        ...
        int find_last_index(const Nodo* hijo,const  Nodo* padre) const;
    };
